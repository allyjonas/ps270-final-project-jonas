...
```{r}
social_inter_plot <- ggplot(media_poli_ideology, aes(x = `Political Affiliation`)) + geom_bar(aes(fill = `Social Media Usage Frequency`), position = "dodge") +
